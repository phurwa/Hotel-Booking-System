...
public class StaffDasboard {
	...
	public StaffDasboard() {
		...
		lblTitle = new JLabel("Staff Dashboard");
		lblTitle.setForeground(new Color(224, 222, 216));
		lblTitle.setFont(new Font("Arial", Font.BOLD, 20));
		lblTitle.setBounds(380, 5, 200, 25);
		pnl1.add(lblTitle);
		...
		lblService.setBounds(390, 12, 200, 25);
		pnl2.add(lblService);

		btnRes = new JButton("Restaurant Service");
		btnRes.setBounds(285, 50, 165, 30);
		btnRes.setBackground(Color.ORANGE);
		btnRes.setFocusable(false);
		pnl2.add(btnRes);
		// action event to open restaurant & Bar page
		btnRes.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				// opens restaurant bar when btnRes is clicked
		...
		btnOther = new JButton("Extra Service");
		btnOther.setBounds(485, 50, 120, 30);
		btnOther.setBackground(Color.ORANGE);
		btnOther.setFocusable(false);
		pnl2.add(btnOther);
		// action event to open extra service page
		btnOther.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				// opens the Other service
				OtherService service = new OtherService();
				service.startShowTable();
				frame.dispose(); // close the current page
			}
