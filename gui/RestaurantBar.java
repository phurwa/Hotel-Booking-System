...
//create default constructor
	public RestaurantBar() {
		...
		try {
			...
			// Query to display room No whose status are checked in
		...
		lblServiceType.setBounds(10, 80, 110, 25);
		...
		cmbServiceType.setBounds(125, 80, 150, 25);
		cmbServiceType.setModel(new DefaultComboBoxModel(new String[] { "Beer", "cold drink" }));
		...
		cmbServiceType.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				item = (String) cmbServiceType.getSelectedItem();
		...
		lblTotal.setBounds(10, 115, 110, 25);
		lblTotal.setForeground(Color.BLACK);
		lblTotal.setFont(new Font("Arial", Font.BOLD, 15));
		pnl2.add(lblTotal);

		txtTotal = new JTextField();
		txtTotal.setBounds(125, 115, 150, 25);
		...
		btnSave.setBounds(230, 185, 80, 30);
		btnSave.setBackground(Color.orange);
		btnSave.setFocusable(false);
		pnl2.add(btnSave);

		btnExit = new JButton("EXIT");
		btnExit.setBounds(330, 185, 80, 30);
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String query = "insert into service(bookingID, serviceType, quantity, rate, total) values(?,?,?,?,?)";
		...
		scrollPane.setBounds(10, 300, 580, 300);
	...
	public void startShowTable() {
		...
		try {
			...
			String query = "select c.fullname, r.roomNo, s.serviceType, s.quantity, s.rate, s.total \r\n"
					...
					+ " where s.serviceType='Beer' or s.serviceType='cold drink'";
...
//main method
	public static void main(String[] args) {
		RestaurantBar window = new RestaurantBar();
